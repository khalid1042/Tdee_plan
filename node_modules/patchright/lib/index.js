...
const { getActionGroup, renderParamsForCall, renderSubtitleForCall, renderTitleForCall, truncateParam } = require("patchright-core/lib/coreBundle").iso;
const { escapeHTML } = require("patchright-core/lib/coreBundle").iso;
const { jsonStringifyForceASCII } = require("patchright-core/lib/coreBundle").utils;
const { createGuid } = require("patchright-core/lib/coreBundle").utils;
const { debugMode } = require("patchright-core/lib/coreBundle").utils;
const { debugLogger } = require("patchright-core/lib/coreBundle").utils;
const { currentZone } = require("patchright-core/lib/coreBundle").utils;
