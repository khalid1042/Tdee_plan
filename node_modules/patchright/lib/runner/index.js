...
var import_coreBundle3 = require("patchright-core/lib/coreBundle");
var import_common10 = require("../common");

// packages/playwright/src/runner/fsWatcher.ts
var chokidar = require("patchright-core/lib/utilsBundle").chokidar;
var FSWatcher = class {
...
var { monotonicTime } = require("patchright-core/lib/coreBundle").iso;
var { spawnAsync } = require("patchright-core/lib/coreBundle").utils;
...
var colors = require("patchright-core/lib/utilsBundle").colors;
var debug2 = require("patchright-core/lib/utilsBundle").debug;
var { ManualPromise } = require("patchright-core/lib/coreBundle").iso;
var { monotonicTime: monotonicTime2 } = require("patchright-core/lib/coreBundle").iso;
var { raceAgainstDeadline } = require("patchright-core/lib/coreBundle").iso;
var { isURLAvailable } = require("patchright-core/lib/coreBundle").utils;
var { launchProcess } = require("patchright-core/lib/coreBundle").utils;
...
var realColors = require("patchright-core/lib/utilsBundle").colors;
var { noColors } = require("patchright-core/lib/coreBundle").iso;
var { msToString } = require("patchright-core/lib/coreBundle").iso;
var { parseErrorStack } = require("patchright-core/lib/coreBundle").utils;
var { getPackageManagerExecCommand } = require("patchright-core/lib/coreBundle").utils;
var { fitToWidth } = require("patchright-core/lib/coreBundle").utils;
...
// packages/playwright/src/reporters/internalReporter.ts
var { monotonicTime: monotonicTime3 } = require("patchright-core/lib/coreBundle").iso;
...
var debug3 = require("patchright-core/lib/utilsBundle").debug;
var { assert } = require("patchright-core/lib/coreBundle").iso;
var { monotonicTime: monotonicTime4, timeOrigin } = require("patchright-core/lib/coreBundle").iso;
var { raceAgainstDeadline: raceAgainstDeadline2 } = require("patchright-core/lib/coreBundle").iso;
...
var { minimatch } = require("patchright-core/lib/utilsBundle");
var { escapeRegExp } = require("patchright-core/lib/coreBundle").iso;
...
var sourceMapSupport = require("patchright-core/lib/utilsBundle").sourceMapSupport;
var { toPosixPath } = require("patchright-core/lib/coreBundle").utils;
...
var import_coreBundle = require("patchright-core/lib/coreBundle");

// packages/playwright/src/reporters/teleEmitter.ts
var import_path5 = __toESM(require("path"));
var { createGuid } = require("patchright-core/lib/coreBundle").utils;
...
// packages/playwright/src/reporters/blob.ts
var mime = require("patchright-core/lib/utilsBundle").mime;
var yazl = require("patchright-core/lib/utilsBundle").yazl;
var { ManualPromise: ManualPromise2 } = require("patchright-core/lib/coreBundle").iso;
var { calculateSha1, createGuid: createGuid2 } = require("patchright-core/lib/coreBundle").utils;
var { removeFolders, sanitizeForFilePath } = require("patchright-core/lib/coreBundle").utils;
...
var { getAsBooleanFromENV } = require("patchright-core/lib/coreBundle").utils;
...
var { noColors: noColors2 } = require("patchright-core/lib/coreBundle").iso;
var { msToString: msToString2 } = require("patchright-core/lib/coreBundle").iso;
var { getAsBooleanFromENV: getAsBooleanFromENV2 } = require("patchright-core/lib/coreBundle").utils;
...
var colors2 = require("patchright-core/lib/utilsBundle").colors;
var mime2 = require("patchright-core/lib/utilsBundle").mime;
var open = require("patchright-core/lib/utilsBundle").open;
var yazl2 = require("patchright-core/lib/utilsBundle").yazl;
var { MultiMap } = require("patchright-core/lib/coreBundle").iso;
var { calculateSha1: calculateSha12 } = require("patchright-core/lib/coreBundle").utils;
var { copyFileAndMakeWritable, removeFolders: removeFolders2, sanitizeForFilePath: sanitizeForFilePath2, toPosixPath: toPosixPath2 } = require("patchright-core/lib/coreBundle").utils;
var { getPackageManagerExecCommand: getPackageManagerExecCommand2, isCodingAgent } = require("patchright-core/lib/coreBundle").utils;
var { HttpServer, serveFolder } = require("patchright-core/lib/coreBundle").utils;
var { gracefullyProcessExitDoNotHang } = require("patchright-core/lib/coreBundle").utils;
var { extractZip } = require("patchright-core/lib/coreBundle").utils;
...
var HtmlBuilder = class {
  ...
  async build(metadata, projectSuites, result, topLevelErrors, machines) {
    ...
    if (this._hasTraces) {
      const traceViewerFolder = import_path8.default.join(require.resolve("patchright-core"), "..", "lib", "vite", "traceViewer");
  ...
  async _writeStaticAssets() {
    const appFolder = import_path8.default.join(require.resolve("patchright-core"), "..", "lib", "vite", "htmlReport");
...
var { MultiMap: MultiMap2 } = require("patchright-core/lib/coreBundle").iso;
var { toPosixPath: toPosixPath3 } = require("patchright-core/lib/coreBundle").utils;
...
var { getAsBooleanFromENV: getAsBooleanFromENV3 } = require("patchright-core/lib/coreBundle").utils;
...
var { getAsBooleanFromENV: getAsBooleanFromENV4 } = require("patchright-core/lib/coreBundle").utils;
...
var { msToString: msToString3 } = require("patchright-core/lib/coreBundle").iso;
var { getAsBooleanFromENV: getAsBooleanFromENV5 } = require("patchright-core/lib/coreBundle").utils;
...
var import_coreBundle2 = require("patchright-core/lib/coreBundle");
var import_util11 = require("../util");
var { toPosixPath: toPosixPath4 } = require("patchright-core/lib/coreBundle").utils;
var kStatusColors = {
  passed: "good",
  failed: "bad",
  timedOut: "terrible",
...
// packages/playwright/src/runner/reporters.ts
var { calculateSha1: calculateSha13 } = require("patchright-core/lib/coreBundle").utils;
...
var colors3 = require("patchright-core/lib/utilsBundle").colors;
var diff = require("patchright-core/lib/utilsBundle").diff;
var { MultiMap: MultiMap3 } = require("patchright-core/lib/coreBundle").iso;
var t = babel3.types;
...
// packages/playwright/src/runner/workerHost.ts
var { removeFolders: removeFolders3 } = require("patchright-core/lib/coreBundle").utils;
...
var colors4 = require("patchright-core/lib/utilsBundle").colors;
var { ManualPromise: ManualPromise3 } = require("patchright-core/lib/coreBundle").iso;
var { eventsHelper } = require("patchright-core/lib/coreBundle").utils;
...
var colors5 = require("patchright-core/lib/utilsBundle").colors;
var debug4 = require("patchright-core/lib/utilsBundle").debug;
var { ManualPromise: ManualPromise4 } = require("patchright-core/lib/coreBundle").iso;
var { monotonicTime: monotonicTime5 } = require("patchright-core/lib/coreBundle").iso;
...
var debug5 = require("patchright-core/lib/utilsBundle").debug;
var { ManualPromise: ManualPromise5 } = require("patchright-core/lib/coreBundle").iso;
var { monotonicTime: monotonicTime6 } = require("patchright-core/lib/coreBundle").iso;
var { removeFolders: removeFolders4 } = require("patchright-core/lib/coreBundle").utils;
...
// packages/playwright/src/runner/testRunner.ts
var { ManualPromise: ManualPromise6 } = require("patchright-core/lib/coreBundle").iso;
var { setPlaywrightTestProcessEnv } = require("patchright-core/lib/coreBundle").utils;
var { gracefullyProcessExitDoNotHang: gracefullyProcessExitDoNotHang2 } = require("patchright-core/lib/coreBundle").utils;
var TestRunnerEvent = {
...
var import_coreBundle4 = require("patchright-core/lib/coreBundle");
...
// packages/playwright/src/runner/testServer.ts
var debug6 = require("patchright-core/lib/utilsBundle").debug;
var open2 = require("patchright-core/lib/utilsBundle").open;
var { ManualPromise: ManualPromise7 } = require("patchright-core/lib/coreBundle").iso;
var { isUnderTest } = require("patchright-core/lib/coreBundle").utils;
var { HttpServer: HttpServer2 } = require("patchright-core/lib/coreBundle").utils;
var { gracefullyProcessExitDoNotHang: gracefullyProcessExitDoNotHang3 } = require("patchright-core/lib/coreBundle").utils;
...
var import_coreBundle5 = require("patchright-core/lib/coreBundle");
...
// packages/playwright/src/runner/watchMode.ts
var colors6 = require("patchright-core/lib/utilsBundle").colors;
var enquirer = require("patchright-core/lib/utilsBundle").enquirer;
var { ManualPromise: ManualPromise8 } = require("patchright-core/lib/coreBundle").iso;
var { createGuid: createGuid3 } = require("patchright-core/lib/coreBundle").utils;
var { getPackageManagerExecCommand: getPackageManagerExecCommand3 } = require("patchright-core/lib/coreBundle").utils;
var { eventsHelper: eventsHelper2 } = require("patchright-core/lib/coreBundle").utils;
...
var { isPathInside } = require("patchright-core/lib/coreBundle").utils;
var { ZipFile } = require("patchright-core/lib/coreBundle").utils;
