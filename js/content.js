...
window.TDEEContent = {
  ...
  routes: {
    ...
    '/diet-plan/': {
      title: 'Diet Plan: Evidence-Based Calorie & Meal Planning Guide | TDEE Calculator',
      metaDescription: 'Learn how to build a personalized diet plan based on your TDEE, macro goals, and fitness targets with structured meal frameworks, food lists, and practical tips.',
      category: 'Diet & Nutrition',
      h1: 'Diet Plan: Comprehensive Meal Planning & Calorie Guide',
      content: `
        <p class="lead-paragraph">A structured <strong>Diet Plan</strong> is the bridge between knowing your target numbers and achieving real-world health and body composition results. Whether your objective is fat loss, muscle retention, or steady energy throughout the day, a well-balanced diet plan aligns your daily food choices with your estimated Total Daily Energy Expenditure (<a href="/">TDEE Calculator</a>).</p>
        ...
        <div class="about-calculator-card" style="margin-bottom: 2rem;">
          <ol style="margin: 0; padding-left: 1.25rem;">
            ...
            <li style="margin-bottom: 0.75rem;"><strong>Distribute Fats and Carbohydrates:</strong> Allocate 20% to 30% of total calories to healthy fats for hormonal regulation, and fill remaining calories with complex carbohydrates to power workouts. Use our <a href="/macro-calculator/">Macro Calculator</a> to finalize your splits.</li>
